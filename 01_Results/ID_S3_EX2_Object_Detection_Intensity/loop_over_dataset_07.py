...
# Corrected path:
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results', 'fpn_resnet', 'results_sequence_1_resnet')
...
while True:
    try:
        ...
        if 'bev_from_pcl' in exec_list:
            ...
            lidar_bev = load_object_from_file(results_fullpath, data_filename, 'lidar_bev')
